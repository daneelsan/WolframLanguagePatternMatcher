...
Test[
	falseLit = ConstructMExpr[False];
	MExprLiteralQ[falseLit]
	,
	True
	,
	TestID->"MExprLiteral-20251022-Y3N5F1"
]

Test[
	trueLit = ConstructMExpr[True];
	MExprLiteralQ[trueLit]
	,
	True
	,
	TestID->"MExprLiteral-20251022-X9X8N8"
]
