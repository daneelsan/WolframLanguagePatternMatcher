...
\begin{description}
    \item[\texttt{MATCH\_HEAD \%e, head, L}] If \texttt{Head[\%e] \neq head}, jump to \texttt{L}
    \item[\texttt{MATCH\_LENGTH \%e, n, L}] If \texttt{Length[\%e] \neq n}, jump to \texttt{L}
    \item[\texttt{MATCH\_LITERAL \%e, v, L}] If \texttt{\%e \neq v}, jump to \texttt{L}
    \item[\texttt{APPLY\_TEST \%e, f, L}] If \texttt{f[\%e] \neq True}, jump to \texttt{L}
\end{description}
